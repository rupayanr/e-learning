...
alter table enrolled_courses add constraint fk_cid foreign key(course_id) references scheduled_courses(course_id);

create index idx_start_date on scheduled_courses(start_date);
alter table enrolled_courses add constraint fk_startdate foreign key(start_date) references scheduled_courses(start_date);
